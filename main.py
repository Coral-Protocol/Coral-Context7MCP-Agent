...
async def main():
    ...
    coral_params = {
        "agentId": agentID,
        "agentDescription": "context7_mcp agent capable of retrieving Context7-compatible library IDs and fetching specific documentation on various topics related to those libraries."
    }
    ...
    agent_tools = await client.get_tools(server_name='context7_mcp')
